...
// });
MongoClient.connect('mongodb+srv://dbuser:S1d08o7Onb940T4I@cluster0.hxhao.mongodb.net/?retryWrites=true&w=majority')
  .then(client => {
    console.log("Connected to the database");
    ...
    app.get('/', (req, res) => {
      ...
      app.post('/traits', (req, res) => {
        ...
        traitsCollection.insertOne(req.body)
        .then(result => {
          console.log(result);
          res.redirect('/');
        }).catch(error =>{
      ...
      app.put('/traits', (req, res)=>{
        ...
        traitsCollection.findOneAndUpdate(
          { name: "Test"},
          {
            $set:{
              name: req.body.name,
